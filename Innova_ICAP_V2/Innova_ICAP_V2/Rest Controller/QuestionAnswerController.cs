...
namespace Innova_ICAP_V2.Controller
{
    ...
    {
        public async Task<List<QuestionAnswersModel>> GetQuestionAnswerList()
        {
            var list = new List<QuestionAnswersModel>();
            ...
            try
            {
                ...
                {
                    var result = JsonConvert.DeserializeObject<List<QuestionAnswersModel>>(json);
